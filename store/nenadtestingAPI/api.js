...
function modules_social_auth_socialaccounts_disconnect_create(payload) {
  return nenadtestingAPI.post(`/modules/social-auth/socialaccounts/${payload.id}/disconnect/`, payload);
}
...
function modules_two_factor_authentication_twofactorauth_list(payload) {
  return nenadtestingAPI.get(`/modules/two-factor-authentication/twofactorauth/`);
}

function modules_two_factor_authentication_twofactorauth_create(payload) {
  return nenadtestingAPI.post(`/modules/two-factor-authentication/twofactorauth/`, payload);
}

function modules_two_factor_authentication_twofactorauth_retrieve(payload) {
  return nenadtestingAPI.get(`/modules/two-factor-authentication/twofactorauth/${payload.id}/`);
}

function modules_two_factor_authentication_twofactorauth_update(payload) {
  return nenadtestingAPI.put(`/modules/two-factor-authentication/twofactorauth/${payload.id}/`, payload);
}

function modules_two_factor_authentication_twofactorauth_partial_update(payload) {
  return nenadtestingAPI.patch(`/modules/two-factor-authentication/twofactorauth/${payload.id}/`, payload);
}

function modules_two_factor_authentication_twofactorauth_destroy(payload) {
  return nenadtestingAPI.delete(`/modules/two-factor-authentication/twofactorauth/${payload.id}/`);
}

function modules_two_factor_authentication_twofactorauth_send_otp_create(payload) {
  return nenadtestingAPI.post(`/modules/two-factor-authentication/twofactorauth/send_otp/`, payload);
}

function modules_two_factor_authentication_verify_destroy(payload) {
  return nenadtestingAPI.delete(`/modules/two-factor-authentication/verify/${payload.id}/`);
}
